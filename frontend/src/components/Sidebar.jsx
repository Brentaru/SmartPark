...
const Sidebar = ({ compact = false, isOpen = true }) => {
  ...
  // Menu definitions - keep simple, readable for students but structured
  const menus = {
    student: [
      { 
        to: '/dashboard', 
      ...
      { 
        to: '/my-slots', 
        label: 'My Parking Slots / Reservations',
    ...
    guard: [
      ...
      { 
        to: '/vehicle-logs', 
        label: 'Vehicle Logs / Scanning',
        icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
      },
      { 
        to: '/check-availability', 
        label: 'Check Slot Availability',
        icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 11a3 3 0 1 0 6 0a3 3 0 0 0-6 0"/><path d="M17.657 16.657L13.414 20.9a1.998 1.998 0 0 1-2.827 0l-4.244-4.243a8 8 0 1 1 11.314 0z"/></svg>
      },
      { 
        to: '/violations', 
  ...
  return (
    <aside className={`app-sidebar ${compact ? 'compact' : ''} ${isOpen ? 'open' : 'closed'}`}>
